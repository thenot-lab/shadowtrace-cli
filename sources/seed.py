...
def load(path: str, subject_hint: str) -> List[Record]:
    ...
    for d in data:
        ...
        authority = {
            "wikipedia": 0.9, "github": 0.75, "linkedin": 0.7,
            "news": 0.8, "academic": 0.85, "gov": 0.95,
            "twitter": 0.5, "blog": 0.5, "search": 0.6,
        }.get(src, 0.5)
        ...
        out.append(Record(
            ...
            meta={k: v for k, v in d.items() if k not in {"title", "snippet", "url", "ts", "date"}},
        ))
    return out
